...
public class OldClient
{
    ...
    public static final int NUM_THREADS = 4 + OldServer.MAX_REQUESTS;
    public static final ExecutorService EXECUTOR = Executors.newFixedThreadPool(NUM_THREADS);
    public static Scanner scanner = new Scanner(System.in);
    public static Socket socket;
    public static ObjectOutputStream objectOutputStream;
    public static ObjectInputStream objectInputStream;
    public static Semaphore queueSlot = new Semaphore(OldServer.MAX_REQUESTS,true);
    ...
    public static Command CURRENT_COMMAND;// = new Command(Action.STARTUP);
                ...
                switch (scanner.nextLine().toUpperCase())
                {
                    case "CONNECT":
                        ...
                        if(socket.isConnected())
                        {
                            ...
                            objectOutputStream.writeObject(new Command(Action.CONNECT));
                ...
                while(isConnected)
                {
                    ...
                    switch(scanner.nextLine().toUpperCase())
                    {
                        ...
                        case "LIST":
                            ...
                            CURRENT_COMMAND = new Command(Action.LIST,directory);
                        ...
                        case "DELETE":
                            ...
                            CURRENT_COMMAND = new Command(Action.DELETE,filenameToDelete);
                            EXECUTOR.submit(new ServeOutgoingRequest(CURRENT_COMMAND));
                            break;
                        ...
                        case "RENAME":
                            ...
                            CURRENT_COMMAND = new Command(Action.RENAME,filenameToRename,newFilename);
                            EXECUTOR.submit(new ServeOutgoingRequest(CURRENT_COMMAND));
                            break;
                        ...
                        case "DOWNLOAD":
                            ...
                            CURRENT_COMMAND = new Command(Action.DOWNLOAD,filenameToDownload);
                            EXECUTOR.submit(new ServeOutgoingRequest(CURRENT_COMMAND));
                            break;
                        ...
                        case "UPLOAD":
                            ...
                            CURRENT_COMMAND = new Command(Action.UPLOAD,filenameToUpload);
                            EXECUTOR.submit(new ServeOutgoingRequest(CURRENT_COMMAND));
                            break;
