...
public class Client
{
    ...
    private static final int DESTINATION_PORT = 25565; //SHOULD BE THE SAME PORT WHEN ON DIFFERENT HOSTS
    private static final String SOURCE_IP = "localhost"; //DELETE WHEN FINISHED
    private static final int SOURCE_PORT = 25566; //DELETE WHEN FINISHED //NEED DIFFERENT PORT NUMBER BECAUSE CLIENT AND SERVER IS ON LOCALHOST
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            //THIS THREAD SHOULD ACCEPT CONNECTIONS AND ACTIVATE A NEW THREAD FOR SERVING THAT CONNECTION WHICH INCLUDES A PACKET LISTENER
            ...
            if (incomingConnectionsListener != null && !incomingConnectionsListener.isClosed()) //IS OPEN FOR NEW CONNECTIONS
            {
                ...
                TaskManager.executor.submit(new TaskManager.ClientInputListener(scanner));
            }
            else
            {
